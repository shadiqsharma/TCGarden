              ...
              <div class="flex flex-wrap items-center justify-between -m-4">
                ...
                <div class="w-auto p-4">
                  <ul class="-m-6">
                    ...
                    <li class="inline-flex p-6"><a class="inline-block text-gray-500 hover:text-gray-600 font-bold" href="/contactus">Contact Us</a></li>
                  </ul>
                </div>
                <div class="w-auto p-4">
                  <div class="flex flex-wrap -m-4">
                    <div class="w-auto p-4"><a class="block" href="https://www.instagram.com/tcgardenresort/"><img src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686757784/TC/skill-icons_instagram_uzvzfs.png" alt=""></a></div>

                    <div class="w-auto p-4"><a class="block" href="https://www.facebook.com/profile.php?id=100093691910696"><img src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686757784/TC/logos_facebook_tmyqia.png" alt=""></a></div>
                  </div>
                </div>
              </div>
            </div>
