              ...
              <div class="w-full lg:w-1/2">
                <div class="mb-4 flex flex-wrap items-end">
                  <div class="mb-4 lg:mb-0 w-full lg:w-2/3 px-3">
                    <img class="w-full h-32 lg:h-48 object-cover rounded-3xl shadow-lg" src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686665817/TC/bbqpit_m2p68r.jpg" alt="">
                  </div>
                  <div class="w-full lg:w-1/3 px-3">
                    <img class="w-full h-32 object-cover rounded-3xl shadow-lg" src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686572394/TC/drone-picture-of-a-room-with-pool-in-the-forest-2021-08-26-16-01-32-utc_1_dpmqe8.jpg" alt="">
                  </div>
                </div>
                <div class="flex flex-wrap items-start">
                  <div class="mb-4 lg:mb-0 w-full lg:w-1/3 px-3">
                    <img class="w-full h-32 object-cover rounded-3xl shadow-lg" src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686665859/TC/empty-modern-meeting-room-2021-08-28-16-46-08-utc_bvarf9.jpg" alt="">
                  </div>
                  <div class="w-full lg:w-2/3 px-3">
                    <img class="w-full h-32 lg:h-48 object-cover rounded-3xl shadow-lg" src="https://res.cloudinary.com/dgsljij3o/image/upload/v1686666040/TC/eventhall_hpf79y.jpg" alt="">
                  </div>
                </div>
              </div>
            </div>
