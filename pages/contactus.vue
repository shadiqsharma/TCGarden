      ...
      <div class="container px-4 mx-auto">
        <div class="flex flex-wrap mb-24 lg:mb-16 justify-between items-center">
          <div class="w-full lg:w-1/2 mb-10 lg:mb-0">
            <span class="inline-block py-px px-2 mb-4 text-xs leading-5 text-yellow-500 bg-yellow-100 font-medium uppercase rounded-3xl">Contact</span>
            <h3 class="mb-4 text-4xl md:text-5xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">Let's Create Extraordinary Experiences Together!</h3>
            <p class="text-lg md:text-xl text-coolGray-500 font-medium">Ready to experience exceptional hospitality? Connect with us now and let us create unforgettable memories together. Your dream stay is just a click away!</p>
          </div>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
            <div class="flex mb-18">
              <div class="inline-flex mr-6 items-center justify-center w-12 h-12 bg-yellow-500 rounded-full">
              ...
              <div class="mt-2">
                ...
                <a class="text-lg text-coolGray-500 hover:text-coolGray-600 font-medium">reservation@tcgarden.com</a>
              </div>
            </div>
            <div class="flex mb-18">
              <div class="inline-flex mr-6 items-center justify-center w-12 h-12 bg-yellow-500 rounded-full">
