    ...
    <section class="py-10 bg-gray-50 overflow-hidden">
      <div class="container mx-auto px-4">
        <div class="relative isolate overflow-hidden bg-yellow-500 py-24 sm:py-32 rounded-3xl">
          <img src="https://res.cloudinary.com/dgsljij3o/image/upload/v1689746994/TC/Logo_TC_Langkawi_ai_2_2_z2jgct.png" alt="" class="absolute inset-0 md:pl-4 -z-10 h-auto w-auto object-cover object-center md:object-center opacity-30">
